...
/**
 * Build the token saving the information by UserDetail in the token payload and 
 * set the due date using the number of second equal to  jwt.expiration value
